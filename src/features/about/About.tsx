      ...
      <div className="border-l-4 border-blue-600 rounded shadow-md p-4 mb-6 mx-2 bg-white dark:bg-gray-800">
        ...
        <section className="mb-6">
          ...
          <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-300">
            British Cycling Club Viewer displays race data for club members from the British
            Cycling website. View points across disciplines (Road & Track, Cyclocross) and
            filter/sort riders.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-300">
            Data is fetched from the British Cycling website. Results include both Road & Track
            and Cyclocross points and race counts. The server filters out duplicate race entries
            by extracting unique event IDs from the HTML response.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <div className="text-sm leading-relaxed text-gray-600 dark:text-gray-300">
            ...
            <ul className="list-disc pl-5 mt-2">
              ...
              <li>Previous years: never expires</li>
            </ul>
          </div>
        </section>

        <section className="mb-6">
          <h3 className="text-lg font-medium mb-2 text-gray-800 dark:text-white">Features</h3>
          <ul className="list-disc pl-5 text-sm leading-relaxed text-gray-600 dark:text-gray-300">
        ...
        <section>
          ...
          <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-300">
            <strong>Note:</strong> All data is pulled directly from the British Cycling website,
            so any inaccuracies there will be reflected here.
          </p>
          <div className="mt-4">
            <a
